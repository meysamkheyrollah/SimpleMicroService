...
class TokenServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExchangeToken = channel.unary_unary(
                '/token.TokenService/ExchangeToken',
                request_serializer=token__pb2.TokenRequest.SerializeToString,
...
def add_TokenServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExchangeToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=token__pb2.TokenRequest.FromString,
...
class TokenService(object):
    ...
    def ExchangeToken(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/token.TokenService/ExchangeToken',
            token__pb2.TokenRequest.SerializeToString,
